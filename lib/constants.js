...
module.exports = {
    ...
    refactoringMode_All: refactoringMode_All,
    refactoringMode_Subset: refactoringMode_Subset,
    refactoringModes: [
        {
            name: 'All refactorings',
            value : refactoringMode_All
        },
        {
            name: 'Subset of refactorings',
            value : refactoringMode_Subset
        }
    ],
